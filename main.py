...
def main():
    ...
    fig.savefig("refraction_cloak_ray_demo.png", dpi=150)
    plt.show()
...
def main():
    ...
    for ax in axes:
        ax.axis('off')
    plt.tight_layout()
    fig1.savefig("hologram_camouflage_panels.png", dpi=150)
    ...
    plt.tight_layout()
    plt.savefig("hologram_phase.png", dpi=150)
    plt.show()
...
ray_img = Image.open("refraction_cloak_ray_demo.png")
holo_img = Image.open("hologram_camouflage_panels.png")
phase_img = Image.open("hologram_phase.png")
